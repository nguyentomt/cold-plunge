  ...
  const [map, setMap] = useState<google.maps.Map | null>(null);
    ...
    return (
      <article className="flex flex-col gap-4 items-center text-lg w-full pt-24 lg:pt-28 text-border">
        ...
        {/* <Map setMap={setMap} /> */}
        <div className="flex gap-8 justify-center bg-yellow-700 bg-opacity-70 lg:text-xl p-4 rounded-3xl"><a href="tel:7146586379">📞  714 658 6379</a>
        <p>⌛ 7am-7pm</p></div>
        ...
        <div>
          ...
          <p className="p-4 lg:text-xl">Thanks for the love on Yelp/Google!</p>
